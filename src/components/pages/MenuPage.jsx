...
const MenuPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Menu | Xzeron Catering Services</title>
        <meta name="description" content="Explore the delicious and diverse menu offerings from Xzeron Catering. From main courses to desserts, discover our signature dishes for your event in Cavite." />
      </Helmet>
