            ...
            <div className="relative z-10">
              <div className="w-full max-w-md mx-auto bg-gradient-to-br from-gold-light to-cream p-8 rounded-2xl shadow-xl border border-gold-light">
                <div className="text-center space-y-4">
                  <div className="w-32 h-32 bg-gradient-to-br from-gold-primary to-gold-dark rounded-full flex items-center justify-center mx-auto">
                    <ChefHat className="w-16 h-16 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold text-brown-primary">Our Expert Chef</h3>
                  <p className="text-gray-600">Years of experience from prestigious establishments</p>
                  <div className="flex justify-center space-x-1">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-5 h-5 text-gold-accent fill-current" />
                    ))}
                  </div>
                  <p className="text-sm text-gray-500">Republic Cavite Restaurant • Town's Delight</p>
                </div>
              </div>
              <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg border border-gold-light">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-600">Licensed & Experienced</div>
                  </div>
                </div>
              </div>
            </div>
